...
import { Eye, EyeOff, User, Mail, Lock, Phone, Users, ArrowRight, Shield, Award } from 'lucide-react'
...
export default function FirebaseRegisterPage() {
  ...
  const handleEmailRegister = async (e: React.FormEvent) => {
    ...
    try {
      const userData = await registerWithEmailPassword(formData)
      login(userData)
      router.push('/')
    } catch (error: any) {
      ...
      <div className="w-full max-w-md relative">
        <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Join VEER NIRMAN</h1>
            <p className="text-gray-600">Create your cadet account</p>
          </div>
          ...
          >
            ...
            {googleLoading ? (
              <span className="text-gray-600">Creating account...</span>
            ) : (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full pl-11 pr-4 py-3 border rounded-xl bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 transition-all duration-200 ${
                    errors.unit ? 'border-red-300 focus:ring-red-500' : 'border-gray-200 focus:ring-blue-500'
                  }`}
                  placeholder="1st Battalion NCC"
                  disabled={loading || googleLoading}
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full pl-11 pr-4 py-3 border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200"
